            ...
            <div className="bg-[#C6E4DA] p-6 rounded-lg shadow-lg w-11/12 max-w-4xl">
                ...
                <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    {Object.keys(formData).map((key) => (
                        <div key={key} className="flex flex-col">
                            ...
                            <input
                                ...
                                className={`border ${errors[key] ? 'border-red-500' : 'border-gray-300'} p-4 rounded-md focus:outline-none focus:ring-2 focus:ring-primary transition duration-200`}
                    ...
                    <div className="flex justify-between mt-8 md:col-span-2 lg:col-span-3">
                        ...
                        <button
                            type="submit"
                            className="bg-[#4285F4] hover:bg-[#0C65F8] text-black p-4 rounded-md transition duration-200 flex items-center"
